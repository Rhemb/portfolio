            ...
            <header className='mb-4'>
                <div className='intro-section text-white d-flex flex-column align-items-center'>
                    <div>
                        ...
                        <p className='small-bio mb-4'>Healthcare transitioned Software Developer based in Bay Area, CA specializing in Front End Web Development</p>
            ...
            <section className="about-section">
                <div className="about-left">
                    <div className='about-paragraph'>
                        <p>Hello! My name is Rheanne and I enjoy building websites to showcase to others! I'm a healthcare turned software engineer after deciding to try programming through various online resources.</p>
                        <p>First attending Coding Dojo, a fullstack software engineering bootcamp, helped guide me with the structure and resources to kickstart my career in tech. Navigating my way to learning new languages and technologies has been a challenging yet-rewarding experience!</p>
